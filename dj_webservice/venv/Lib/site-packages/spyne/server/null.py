...
class NullServer(ServerBase):
    ...
    def __init__(self, app, ostr=False, locale='C', appinit=True):
        ...
        self.service = _FunctionProxy(self, self.app, shark=False)
        self.shark = _FunctionProxy(self, self.app, shark=True)
...
class _FunctionProxy(object):
    def __init__(self, server, app, shark):
        self._app = app
        self._server = server
        self.in_header = None
        self.shark = shark
    ...
    def __getattr__(self, key):
        return _FunctionCall(self._app, self._server, key, self.in_header,
                  self._server.ostr, self._server.locale, self.shark)
...
class _FunctionCall(object):
    def __init__(self, app, server, key, in_header, ostr, locale, shark):
        self.app = app
